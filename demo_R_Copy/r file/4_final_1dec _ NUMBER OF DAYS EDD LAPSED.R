...
#df_final
df1_f= df1[1:(nrow(df1)-1), c(4,6:10,16:17,23,26,32:35)]    
...
com1_df= com1_df[c(1,2,8,9,5,3,4,6,7,10:15)]



com1_df <- cbind(
  com1_df[, 1:11], 
  "NUMBER OF DAYS EDD LAPSED" = NA, 
  com1_df[, 12:ncol(com1_df)]
)

com1_df <- cbind(
  com1_df[, 1:12], 
  "LAPSED STATUS" = NA, 
  com1_df[, 13:ncol(com1_df)]
)
...
pr_5id<- paste(com1_df[[1]], com1_df[[2]],com1_df[[3]],com1_df[[10]],com1_df[[11]],sep="_") 
#
...
jn_gv_aj[16] = as.Date( as.integer( unlist(jn_gv_aj[16])), origin = "1899-12-30")
...
aj12345_r_f= aj12345_r[c(1,2,9:23)]#11,12,>4,5
