...
jn_gv_aj= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\Material Status Master Tracker.xlsx",
                    sheet=7,colNames=T, detectDates=F) #########$
jn_gv_aj= jn_gv_aj[c(1,2,2,3:36)] #############################$
...
write.xlsx(merged_data1,
    "I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\2_AJ_item_final_rm.xlsx",
...
jn_gv_bu= read.xlsx("I:/1_upwork/004_work with Jinu_____data analysis/demo_R_Copy/Material Status Master Tracker.xlsx",
                    sheet=8,colNames=T, detectDates=F)  

jn_gv_bu= jn_gv_bu[c(1,2,2,3:36)] #############################$
...
# final bu file
write.xlsx(merged_data11,"I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\2_BU_item_final_rm.xlsx",
           asTable = T,colNames=T)
